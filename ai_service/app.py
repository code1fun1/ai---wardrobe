...
class AIWardrobeService:
    ...
    def generate_outfit_recommendation(self, clothing_items: List[Dict], occasion: str = "casual", preferences: Dict = None) -> Dict:
        ...
        if not suitable_items:
            suitable_items = clothing_items  # Fallback to all items
    ...
    def get_style_advice(self, outfit: Dict, occasion: str) -> Dict:
